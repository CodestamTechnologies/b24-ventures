  ...
  return (
    <div className='min-h-[90vh] lg:min-h-screen   2xl:-mb-64 bg-background relative overflow-hidden'>
      ...
      <div className='hidden lg:flex justify-center w-full'>
        ...
        <div className='w-full max-w-[1800px] mx-auto px-8 xl:px-12  2xl:px-16 4k:px-24 relative h-[90vh] 2xl:h-[80vh] 4k:h-[70vh]'>
          {/* Left Side Elements */}
            <div className="absolute top-5 2xl:mt-6 2xl:ml-32 left-36 w-48 h-48 4k:w-52 4k:h-52 z-20">
              <Image
                src="/logo.png"
                alt="Logo"
                width={208}
          ...
          <div className='absolute left-0 w-1/2 h-full 2xl:mt-40'>
            {/* Logo */}

            {/* Main 3D Model */}
            <div className='absolute top-56 2xl:left-96 left-60 transform -translate-x-1/2 -translate-y-1/2 w-52 h-64 2xl:w-64 2xl:h-80 z-20'>
              <Image 
                src="/main.webp" 
                alt="Main model" 
                width={224}
            ...
            {/* <div className='2xl:left-56'> */}

            <div className='absolute top-72 left-96 2xl:ml-32 mr-10 w-36 h-36 2xl:w-40 2xl:h-40 rounded-3xl bg-white shadow-lg flex justify-center items-center'>
              <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-10 h-10 4k:w-11 4k:h-11">
                <path d="M2 2h20v20H2V2zm2 2v4h4v4H4v4h4v4h4v-4h4v4h4v-4h-4v-4h4V8h-4V4h-4v4H8V4H4zm8 8H8v4h4v-4zm0-4v4h4V8h-4z" fill="black" />
              </svg>
            </div>
            
            {/* Curved SVG */}
            <div className="absolute left-80 ml-5 2xl:ml-40 top-[22rem] w-24 h-40 2xl:w-26 2xl:h-42 transform rotate-45">
            ...
            <div className='absolute top-96 mt-10 2xl:ml-32 left-60 w-36 h-36 2xl:w-40 2xl:h-40 rounded-3xl bg-white z-10 shadow-lg flex flex-col justify-center items-center p-4'>
              <div className='flex flex-col -space-y-1 mb-2'>
                <span className='font-bold text-black text-sm 4k:text-sm'>Our</span>
                <span className='font-bold text-black text-sm 4k:text-sm'>Creators</span>
              </div>
              <div className="flex -space-x-2">
                {['/part1.webp', '/part2.webp', '/part3.webp'].map((src, i) => (
                  <div key={i} className="w-8 h-8 4k:w-9 4k:h-9 rounded-full overflow-hidden border-2 border-white shadow-sm">
            ...
            {/* Circular Div */}
            <div className='absolute top-[26rem] left-96 2xl:ml-40 2xl:mt-2 ml-5 w-20 h-20 4k:w-22 4k:h-22 z-0'>
              <CircularDiv/>
            </div>
          </div>

          {/* Right Side Content */}
          <div className="absolute right-0 w-1/2 lg:mt-16 2xl:mt-56 2xl:right-32 4k:ml-24 h-full flex pl-12 4k:pl-16">
            <div className="w-full max-w-[600px] 4k:max-w-[650px]">
              {/* Main Content Box */}
              <div className="p-8 4k:p-10 rounded-2xl border border-gray-300">
                <motion.h1 className="text-3xl 4k:text-3xl font-bold tracking-tight mb-6 leading-tight">
                  <span className="inline-block bg-gradient-to-r from-foreground to-brand-maroon bg-clip-text text-transparent">
                    Actionable
                  </span>{' '}
                  <span className="inline-block">Startup</span>
                ...
                <p className="text-base 4k:text-base text-gray-600 mt-4 leading-relaxed">
                  Cut through the noise. Get curated venture news, smart insights, and essential market trends built for founders and investors.
                </p>
