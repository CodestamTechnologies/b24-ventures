      ...
      <div className="container mx-auto px-4">
        <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center max-w-6xl mx-auto">
          <div className="text-left">
              <motion.h2 variants={itemFadeUp} className="text-4xl md:text-5xl font-bold font-display mb-6 text-foreground"> Built for the <span className="text-brand-maroon">Venture Economy</span>. </motion.h2>
              <motion.p variants={itemFadeUp} className="text-lg md:text-xl text-muted-foreground mb-6 leading-relaxed"> Brown24 Ventures cuts through the noise, delivering curated startup intelligence and AI-powered insights directly to decision-makers. </motion.p>
              {/* Line 26 Fix */}
           ...
           <motion.div variants={itemFadeUp} transition={{ delay: 0.2 }} className="relative aspect-4/3 rounded-xl border border-border shadow-lg overflow-hidden">
                 <Image src="https://images.unsplash.com/photo-1499750310107-5fef28a66643?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="About Brown24 Ventures - workspace" layout="fill" objectFit="cover" className="transition-transform duration-500 hover:scale-105" quality={80} sizes="(max-width: 1024px) 100vw, 50vw" />
