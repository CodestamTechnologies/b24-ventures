...
export default function ServicesSection() {
  ...
  return (
    <motion.div 
      ...
      className={`${geist.className} w-full bg-background py-12 md:py-16 lg:py-20 xl:py-24 2xl:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden`}
    >
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-gray-50 p-6 sm:p-8 md:p-10 rounded-xl shadow-sm h-full border border-gray-200 relative overflow-hidden"
              >
                {/* Decorative elements */}
                <motion.div 
                  initial={{ scale: 0 }}
                ...
                >
                  ...
                  <motion.div 
                    className={`absolute inset-0 z-0 ${
                      activeService === index ? 'bg-brand-maroon' : 'bg-gray-100'
                    }`}
