...
export default function ServicesSection() {
  ...
  return (
    <div className={`${geist.className} relative w-full overflow-hidden -mt-1`}>
      ...
      {/* Content container - Restored entry animations for desktop */}
      {isMobile ? (
        <div className="relative z-10 w-full py-12 md:py-16 lg:py-20 xl:py-24 2xl:py-32 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className='mb-8 md:mb-12 lg:mb-16 text-center max-w-3xl mx-auto'>
              <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gray-900`}>
                Why <span className="inline-block text-brand-maroon">Brown24</span>?
              </h2>
            ...
            <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-10 xl:gap-12">
              ...
              <div className="lg:w-1/2">
                <div className="bg-white/80 backdrop-blur-sm p-6 sm:p-8 md:p-10 rounded-xl shadow-sm h-full border border-gray-200/50 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-16 h-16 bg-brand-maroon rounded-bl-full opacity-10" />
                  <div className="absolute bottom-0 left-0 w-24 h-24 bg-blue-500 rounded-tr-full opacity-10" />
                  
                  <h3 className={`text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-black`}>
                    {services[activeService].title}
                  </h3>
                  <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed md:leading-relaxed">
              ...
              <div className="lg:w-1/2" ref={scope}>
                <div className="space-y-4 sm:space-y-5 md:space-y-6">
                  {services.map((service, index) => (
                    <div
                      key={index}
                      className={`service-item cursor-pointer p-5 sm:p-6 md:p-7 rounded-lg relative overflow-hidden ${
                        activeService === index 
        ...
        <motion.div 
          ...
          className="relative z-10 w-full py-12 bg-background md:py-16 lg:py-20 xl:py-24 2xl:py-32 px-4 sm:px-6 lg:px-8"
        >
          <div className="max-w-7xl bg-background mx-auto">
            <motion.div 
              initial={{ opacity: 0, y: -20 }}
