...
export default function CustomerSegmentation() {
  ...
  return (
    <motion.section
      ...
      className={`relative flex flex-col lg:flex-row justify-center bg-background z-50 -mb-2 items-center ${roboto.className} p-6 md:p-12 max-w-7xl mx-auto gap-12 overflow-hidden`}
    >
      {/* Left Section */}
      <motion.div
